...
var foodgame = function(){
    ...
    function startgame(){
        ...
        startsnakegame = setInterval(snakegame,100);
    };		
...
var flushGame = function(){
    ...
    powerCount=0;
    increasing=true;
    powerseq = setInterval(powerMet,130);
};	 
...
var trainGame = function(){
    ...
    buttonI1.src = "images/templates/scissors2.png";
    ...
    buttonI2.src = "images/templates/stone.png";
    ...
    buttonI3.src = "images/templates/paper.png";
    ...
    setTimeout(function(){
        if (petWin==true){
            ...
            if(pet.level==3){//if pet is adult, training increases its lifespan
                countForEvolution-=780; //each successful training increase its life span by 10mins
            }
        }
...
var sickGame = function(){
    ...
    var buttonI1 = new Image();
    buttonI1.src = "images/templates/up.png";
    ...
    var ctxb2 = button2.getContext("2d");
    var buttonI2 = new Image();
    buttonI2.src = "images/templates/target.png";
    ...
    var ctxb3 = button3.getContext("2d");
    var buttonI3 = new Image();
    buttonI3.src = "images/templates/down.png";
    buttonI3.onload = function(){
        ctxb3.drawImage(buttonI3,15, 15, 30, 30);
